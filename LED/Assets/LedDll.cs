...
//*****************************************************************************
         ...
         *				非0				创建节目对象成功
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_CreateProgram", CharSet = CharSet.Unicode)]
         ...
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddProgram", CharSet = CharSet.Unicode)]
         ...
         *				非0				失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_SetProgramTime", CharSet = CharSet.Unicode)]
        ...
        *				非0					失败，调用LV_GetError来获取错误信息	
        ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddImageTextArea", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddFileToImageTextArea", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddSingleLineTextToImageTextArea", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddMultiLineTextToImageTextArea", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddStaticTextToImageTextArea", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_QuickAddSingleLineTextArea", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddDigitalClockArea", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddTimeArea", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddClockArea", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AddWaterBorder", CharSet = CharSet.Unicode)]
         ...
         *				hProgram				节目对象句柄
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_DeleteProgram", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_Send", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_TestOnline", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_SetBasicInfo", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_SetOEDA", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_AdjustTime", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_PowerOnOff", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_TimePowerOnOff", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_SetBrightness", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_TimeBrightness", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_SetLanguage", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_LedTest", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_TimeLocker", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_CancelLocker", CharSet = CharSet.Unicode)]
         ...
         *				非0						失败，调用LV_GetError来获取错误信息	
         ********************************************************************************************/
        [DllImport("lv_led", EntryPoint = "LV_SetLedCommunicationParameter", CharSet = CharSet.Unicode)]
